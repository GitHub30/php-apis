<?php
// Usage: ip-ssl.php?server_host=127.0.0.1&hostname=example.com
// Usage: ip-ssl.php?server_host=localhost&hostname=example.com
...
$result = [
    ...
    'isCorrectlyInstalled' => !!@stream_socket_client("ssl://{$server_host}:443", $ec, $em, 60, STREAM_CLIENT_CONNECT, stream_context_create(['ssl' => ['peer_name' => $hostname]])),
